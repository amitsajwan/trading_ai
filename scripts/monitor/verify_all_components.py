...
# Ensure project root (parent of scripts) is on sys.path so imports like `mongodb_schema` resolve
sys.path.insert(0, str(Path(__file__).parent.parent.parent))
# Also keep scripts directory in the path for backward-compatible local imports
