...
> Canonical agent documentation and implementation details are maintained in `engine_module/AGENTS.md` — refer there for up-to-date inputs, outputs, and behavior. This section is a high-level summary.
