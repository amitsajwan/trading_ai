#!/usr/bin/env bash
# Zerodha Authentication Quick Reference Card
...
echo "  Fix: rm credentials.json && python start_unified.py --live"
echo ""
echo "Problem: No credentials found"
echo "  Fix: export KITE_API_KEY=\"...\" && python start_unified.py --live"
echo ""
